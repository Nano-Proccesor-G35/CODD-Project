...
Port ( data            : in  STD_LOGIC_VECTOR (11 downto 0);
     ...
     Address_To_Jump : out STD_LOGIC_VECTOR (3 downto 0);  
...
signal Reg_En0, Mux0_Out, Mux0_I0, Mux0_I1,
 Reg_Sel_Out_A, Reg_Sel_Out_B, Mem_Sel : STD_LOGIC_VECTOR (3 downto 0);  
...
InstructionDecorder : Instruction_Decoder
  Port map( data            => I_Dec_In,
            ...
            Reg_En          => Reg_En0(2 downto 0),  
            Reg_Sel_A       => Reg_Sel_Out_A(2 downto 0),
            Load_sel        => I_Load_sel,
            Immediate_val   => Im_Val,
            Reg_Sel_B       => Reg_Sel_Out_B(2 downto 0),
